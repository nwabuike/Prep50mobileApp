...
Route::post('/payMe', 'Api\PaymentController@store');
...
Route::get('/dept', 'SinglePageController@getAllDept');
Route::get('/state', 'SinglePageController@getAllState');
Route::get('/poly', 'SinglePageController@getAllPoly');
Route::get('/uni', 'SinglePageController@getAllUni');
...
Route::get('/getTopicsInSubjects/{subject_id}', 'Api\TopicsController@getTopicsInSubjects');
...
Route::get('/getQuestionsInObjective/{objective_id}', 'Api\QuestionsController@getQuestionInObj');
